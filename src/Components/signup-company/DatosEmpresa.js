...
function DatosEmpresa() {
    ...
    return (
        <div className="datos-empresa-container">
            ...
            <input type="text" placeholder="Correo electrónico*" value={form.correoElectronico} onChange={(e)=>setForm({...form,correoElectronico:e.target.value})}/>
            ...
            <input type = "text" placeholder="Página web*" value={form.pagina} onChange={(e)=>setForm({...form,pagina:e.target.value})}/>
        </div>
    )
}
